...
type AggregateTechnicalInfrastructure {
  count: Int!
}
...
type Mutation {
  ...
  updateTechnicalInfrastructure(data: TechnicalInfrastructureUpdateInput!, where: TechnicalInfrastructureWhereUniqueInput!): TechnicalInfrastructure
  updateManyTechnicalInfrastructures(data: TechnicalInfrastructureUpdateManyMutationInput!, where: TechnicalInfrastructureWhereInput): BatchPayload!
  upsertTechnicalInfrastructure(where: TechnicalInfrastructureWhereUniqueInput!, create: TechnicalInfrastructureCreateInput!, update: TechnicalInfrastructureUpdateInput!): TechnicalInfrastructure!
  deleteTechnicalInfrastructure(where: TechnicalInfrastructureWhereUniqueInput!): TechnicalInfrastructure
  deleteManyTechnicalInfrastructures(where: TechnicalInfrastructureWhereInput): BatchPayload!
...
input PatternScalarWhereInput {
  ...
  technicalInfrastructureWeight: Int
  technicalInfrastructureWeight_not: Int
  technicalInfrastructureWeight_in: [Int!]
  technicalInfrastructureWeight_not_in: [Int!]
  technicalInfrastructureWeight_lt: Int
  technicalInfrastructureWeight_lte: Int
  technicalInfrastructureWeight_gt: Int
  technicalInfrastructureWeight_gte: Int
  createdAt: DateTime
  createdAt_not: DateTime
  createdAt_in: [DateTime!]
  createdAt_not_in: [DateTime!]
...
type Query {
  ...
  technicalInfrastructure(where: TechnicalInfrastructureWhereUniqueInput!): TechnicalInfrastructure
  technicalInfrastructures(where: TechnicalInfrastructureWhereInput, orderBy: TechnicalInfrastructureOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [TechnicalInfrastructure]!
  technicalInfrastructuresConnection(where: TechnicalInfrastructureWhereInput, orderBy: TechnicalInfrastructureOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): TechnicalInfrastructureConnection!
...
type Subscription {
  ...
  technicalInfrastructure(where: TechnicalInfrastructureSubscriptionWhereInput): TechnicalInfrastructureSubscriptionPayload
...
type Table {
  ...
  technical_infrastructure_entry_ids(where: TechnicalInfrastructureWhereInput, orderBy: TechnicalInfrastructureOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [TechnicalInfrastructure!]
...
input TableCreateInput {
  ...
  technical_infrastructure_entry_ids: TechnicalInfrastructureCreateManyWithoutTable_idsInput
...
input TableUpdateDataInput {
  ...
  technical_infrastructure_entry_ids: TechnicalInfrastructureUpdateManyWithoutTable_idsInput
...
input TableWhereInput {
  ...
  technical_infrastructure_entry_ids_every: TechnicalInfrastructureWhereInput
  technical_infrastructure_entry_ids_some: TechnicalInfrastructureWhereInput
  technical_infrastructure_entry_ids_none: TechnicalInfrastructureWhereInput
...
type TechnicalInfrastructureConnection {
  pageInfo: PageInfo!
  edges: [TechnicalInfrastructureEdge]!
  aggregate: AggregateTechnicalInfrastructure!
}

input TechnicalInfrastructureCreateInput {
  id: ID
...
input TechnicalInfrastructureCreateManyWithoutTable_idsInput {
  create: [TechnicalInfrastructureCreateWithoutTable_idsInput!]
  connect: [TechnicalInfrastructureWhereUniqueInput!]
}

input TechnicalInfrastructureCreateWithoutTable_idsInput {
  id: ID
  text: String!
  note: String
  createdBy: UserCreateOneInput!
...
type TechnicalInfrastructureEdge {
  node: TechnicalInfrastructure!
  cursor: String!
}

enum TechnicalInfrastructureOrderByInput {
  id_ASC
  id_DESC
  text_ASC
  text_DESC
...
type TechnicalInfrastructurePreviousValues {
  id: ID!
  text: String!
  note: String
  createdAt: DateTime!
...
input TechnicalInfrastructureScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  updatedAt_gt: DateTime
  updatedAt_gte: DateTime
  AND: [TechnicalInfrastructureScalarWhereInput!]
  OR: [TechnicalInfrastructureScalarWhereInput!]
  NOT: [TechnicalInfrastructureScalarWhereInput!]
}

type TechnicalInfrastructureSubscriptionPayload {
  mutation: MutationType!
  node: TechnicalInfrastructure
  updatedFields: [String!]
...
input TechnicalInfrastructureSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: TechnicalInfrastructureWhereInput
  AND: [TechnicalInfrastructureSubscriptionWhereInput!]
  OR: [TechnicalInfrastructureSubscriptionWhereInput!]
  NOT: [TechnicalInfrastructureSubscriptionWhereInput!]
}

input TechnicalInfrastructureUpdateInput {
...
input TechnicalInfrastructureUpdateManyDataInput {
  text: String
  note: String
}

input TechnicalInfrastructureUpdateManyMutationInput {
  text: String
  note: String
}

input TechnicalInfrastructureUpdateManyWithoutTable_idsInput {
  create: [TechnicalInfrastructureCreateWithoutTable_idsInput!]
  delete: [TechnicalInfrastructureWhereUniqueInput!]
  connect: [TechnicalInfrastructureWhereUniqueInput!]
  set: [TechnicalInfrastructureWhereUniqueInput!]
  disconnect: [TechnicalInfrastructureWhereUniqueInput!]
  update: [TechnicalInfrastructureUpdateWithWhereUniqueWithoutTable_idsInput!]
  upsert: [TechnicalInfrastructureUpsertWithWhereUniqueWithoutTable_idsInput!]
  deleteMany: [TechnicalInfrastructureScalarWhereInput!]
  updateMany: [TechnicalInfrastructureUpdateManyWithWhereNestedInput!]
}

input TechnicalInfrastructureUpdateManyWithWhereNestedInput {
  where: TechnicalInfrastructureScalarWhereInput!
  data: TechnicalInfrastructureUpdateManyDataInput!
}

input TechnicalInfrastructureUpdateWithoutTable_idsDataInput {
  text: String
  note: String
  createdBy: UserUpdateOneRequiredInput
  updatedBy: UserUpdateOneRequiredInput
...
input TechnicalInfrastructureUpdateWithWhereUniqueWithoutTable_idsInput {
  where: TechnicalInfrastructureWhereUniqueInput!
  data: TechnicalInfrastructureUpdateWithoutTable_idsDataInput!
}

input TechnicalInfrastructureUpsertWithWhereUniqueWithoutTable_idsInput {
  where: TechnicalInfrastructureWhereUniqueInput!
  update: TechnicalInfrastructureUpdateWithoutTable_idsDataInput!
  create: TechnicalInfrastructureCreateWithoutTable_idsInput!
}

input TechnicalInfrastructureWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  updatedAt_gt: DateTime
  updatedAt_gte: DateTime
  AND: [TechnicalInfrastructureWhereInput!]
  OR: [TechnicalInfrastructureWhereInput!]
  NOT: [TechnicalInfrastructureWhereInput!]
}

input TechnicalInfrastructureWhereUniqueInput {
  id: ID
}
